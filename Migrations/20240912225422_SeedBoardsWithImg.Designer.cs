...
namespace SurfsUp.Migrations
{
    ...
    [Migration("20240912225422_SeedBoardsWithImg")]
    partial class SeedBoardsWithImg
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SurfsUp.Models.Board", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BoardId = 1,
                            Equipment = "",
                            ImagePath = "/images/surfboards/surfboard-1",
                            Length = 6.0,
                            Name = "The Minilog",
                            Price = 565,
                            Thickness = 2.75,
                        ...
                        new
                        {
                            BoardId = 2,
                            Equipment = "",
                            ImagePath = "/images/surfboards/surfboard-2",
                        ...
                        new
                        {
                            BoardId = 3,
                            Equipment = "",
                            ImagePath = "/images/surfboards/surfboard-3",
                        ...
                        new
                        {
                            BoardId = 4,
                            Equipment = "",
                            ImagePath = "/images/surfboards/surfboard-4",
                        ...
                        new
                        {
                            BoardId = 5,
                            Equipment = "",
                            ImagePath = "/images/surfboards/surfboard-5",
                        ...
                        new
                        {
                            BoardId = 6,
                            Equipment = "",
                            ImagePath = "/images/surfboards/surfboard-6",
                            Length = 5.5,
                            Name = "The Bomb",
                            Price = 645,
                            Thickness = 2.5,
                        ...
                        new
                        {
                            BoardId = 7,
                            Equipment = "",
                            ImagePath = "/images/surfboards/surfboard-7",
                        ...
                        new
                        {
                            BoardId = 8,
                            Equipment = "Paddle",
                            ImagePath = "/images/surfboards/surfboard-8",
                            Length = 12.6,
                            Name = "Naish One",
                            Price = 854,
                            Thickness = 6.0,
                        ...
                        new
                        {
                            ...
                            ImagePath = "/images/surfboards/surfboard-9",
                            Length = 11.6,
                            Name = "Six Tourer",
                            Price = 611,
                            Thickness = 6.0,
                        ...
                        new
                        {
                            BoardId = 10,
                            Equipment = "Fin, Paddle, Pump, Leash",
                            ImagePath = "/images/surfboards/surfboard-10",
                            Length = 14.0,
                            Name = "Naish Maliko",
                            Price = 1304,
                            Thickness = 6.0,
